      ...
      <div class="card-body">
        ...
        <form class="cmxform" id="commentForm" method="get" action="#">
          <fieldset>
            ...
            <div class="form-group">
              <label for="ccomment">Your comment (required)</label> <textarea id="ccomment" class="form-control" name="comment" required></textarea> </div>
  ...
  <div class="col-lg-12">
    <div class="card">
      <div class="card-body">
        ...
        <form class="cmxform" id="signupForm" method="POST" action="form_page.php">
          <fieldset>
            <div class="form-group">
