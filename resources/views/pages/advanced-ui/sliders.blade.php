    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="template-demo">
          ...
          <p class="mt-3">Value: <span id="huge-value"></span>
          </p>
        </div>
      </div>
      <div class="card-body">
        ...
        <div class="template-demo">
          ...
          <div class="d-flex justify-content-between">
            <p class="mt-3">Value: <span id="skip-value-lower"></span>
            </p>
            <p class="mt-3">Value: <span id="skip-value-upper"></span>
            </p>
          </div>
        </div>
      </div>
    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="template-demo">
          ...
          <div class="d-flex justify-content-between">
            <p class="mt-3">Value: <span id="skip-value-lower-2"></span>
            </p>
            <p class="mt-3">Value: <span id="skip-value-upper-2"></span>
            </p>
          </div>
        </div>
      </div>
      <div class="card-body">
        ...
        <div class="template-demo">
          ...
          <div class="d-flex justify-content-between">
            <p class="mt-3">Value: <span id="skip-value-lower-3"></span>
            </p>
            <p class="mt-3">Value: <span id="skip-value-upper-3"></span>
            </p>
          </div>
        </div>
      </div>
