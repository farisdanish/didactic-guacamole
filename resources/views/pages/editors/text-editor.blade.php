    ...
    <div class="card">
      <div class="card-body">
        ...
        <div id="summernoteExample">
          ...
          <img src="{{ url('assets/images/samples/300x300/1.jpg') }}" class="ml-2 mb-2 w-25" alt="sample image">
...
<div class="row grid-margin">
  <div class="col-lg-12">
    <div class="card">
      <div class="card-body">
        <h4 class="card-title">Tinymce Editor</h4> <textarea id='tinyMceExample'>
...
<div class="row">
  <div class="col-lg-12">
    <div class="card">
      <div class="card-body">
        <h4 class="card-title">Simplemde Editor</h4> <textarea id="simpleMde">
      </textarea>
      </div>
    </div>
  </div>
