  ...
  <div class="col-12 grid-margin">
    <div class="card">
      <div class="card-body">
        ...
        <p class="card-description"> Add class <code>.alert-fill-*</code> with <code>.alert</code> </p>
      ...
      <div class="card-body">
        ...
        <form>
          <div class="form-group">
            ...
            <label class="mt-4" for="message">Message</label> <textarea placeholder="Write some message here" id="message" class="form-control" required>Sample content</textarea> </div>
          <button type="submit" class="btn btn-success">
            <span class="glyphicon glyphicon-ok" aria-hidden="true"></span> Notify</button>
        </form>
      </div>
    </div>
  </div>
