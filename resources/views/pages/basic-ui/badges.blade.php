          ...
          <table class="table mb-0">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="pr-0 text-right">
                  <div class="badge badge-info">Primary</div>
                </td>
              </tr>
              <tr>
          ...
          <table class="table mb-0">
            ...
            <tbody>
              <tr>
                <td class="pl-0">Default label</td>
                <td class="pr-0 text-right">
                  <div class="badge badge-primary badge-pill">Default</div>
                </td>
              </tr>
              <tr>
                <td class="pl-0">Primary label</td>
                <td class="pr-0 text-right">
                  <div class="badge badge-info badge-pill">Primary</div>
                </td>
              </tr>
              <tr>
                <td class="pl-0">Danger label</td>
        ...
        <div class="template-demo">
          <table class="table mb-0">
            ...
            <tbody>
              <tr>
                <td class="pl-0">
                  <div class="badge badge-outline-primary badge-pill">Default</div>
                </td>
                <td class="pr-0 text-right">
                  <div class="badge badge-outline-primary">Default</div>
                </td>
              </tr>
              <tr>
                <td class="pl-0">
                  <div class="badge badge-outline-info badge-pill">Primary</div>
                </td>
                <td class="pr-0 text-right">
                  <div class="badge badge-outline-info">Primary</div>
                </td>
              </tr>
              <tr>
                <td class="pl-0">
              ...
              <tr>
                ...
                <td class="pr-0 text-right">
                  <div class="badge badge-pill badge-danger">
                    <i class="mdi mdi-email mr-2"></i>12</div>
                </td>
              </tr>
              <tr>
                <td class="pl-0">Icon With Text</td>
                <td class="pr-0 text-right">
                  <div class="badge badge-pill badge-success">12 <i class="mdi mdi-email ml-2"></i>
                  </div>
                </td>
              </tr>
              <tr>
