        ...
        <div class="row">
          <div class="col-md-12 mb-5">
            <div class="card rounded shadow-none">
              <div class="card-body">
                <div class="row">
                  <div class="col-md-4 d-flex align-items-start flex-wrap">
                    <div class="user-avatar mb-2 mb-xl-0">
                      <img src="{{ url('assets/images/faces/face3.jpg') }}" alt="profile image" class="profile-img img-lg rounded-circle">
                  ...
                  <div class="row">
                    ...
                    <div class="col d-flex align-items-center">
                      <div class="image-grouped ml-auto">
                        <img src="{{ url('assets/images/faces/face20.jpg') }}" data-toggle="tooltip" data-placement="top" title="Mary Sharp" alt="profile image">
                        <img src="{{ url('assets/images/faces/face17.jpg') }}" data-toggle="tooltip" data-placement="top" title="Cory Medina" alt="profile image">
                        <img src="{{ url('assets/images/faces/face14.jpg') }}" data-toggle="tooltip" data-placement="top" title="Clyde Hammond" alt="profile image">
            ...
            <div class="card rounded shadow-none">
              <div class="card-body">
                <div class="row">
                  <div class="col-md-4 d-flex align-items-start flex-wrap">
                    <div class="user-avatar mb-2 mb-xl-0">
                      <img src="{{ url('assets/images/faces/face2.jpg') }}" alt="profile image" class="profile-img img-lg rounded-circle">
                      <span class="edit-avatar-icon"><i class="mdi mdi-camera"></i></span>
                    </div>
                    <div class="wrapper pl-xl-4">
                      <div class="wrapper d-flex align-items-center">
              ...
              <div class="wrapper border-top">
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col d-flex align-items-center">
                      <div class="image-grouped ml-auto">
                        <img src="{{ url('assets/images/faces/face11.jpg') }}" data-toggle="tooltip" data-placement="top" title="Mary Sharp" alt="profile image">
                        <img src="{{ url('assets/images/faces/face12.jpg') }}" data-toggle="tooltip" data-placement="top" title="Cory Medina" alt="profile image">
                        <img src="{{ url('assets/images/faces/face23.jpg') }}" data-toggle="tooltip" data-placement="top" title="Clyde Hammond" alt="profile image">
                        <div class="text-avatar" data-toggle="tooltip" data-placement="top" title="4 More Peoples">+4</div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="wrapper border-top">
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col d-flex align-items-center">
                      <div class="image-grouped ml-auto">
                        <img src="{{ url('assets/images/faces/face8.jpg') }}" data-toggle="tooltip" data-placement="top" title="Mary Sharp" alt="profile image">
                        <img src="{{ url('assets/images/faces/face7.jpg') }}" data-toggle="tooltip" data-placement="top" title="Cory Medina" alt="profile image">
                        <img src="{{ url('assets/images/faces/face9.jpg') }}" data-toggle="tooltip" data-placement="top" title="Clyde Hammond" alt="profile image">
                        <div class="text-avatar" data-toggle="tooltip" data-placement="top" title="4 More Peoples">+4</div>
                      </div>
                    </div>
                  </div>
            ...
            <div class="card rounded shadow-none">
              <div class="card-body">
                <div class="row">
                  <div class="col-md-4 d-flex align-items-start flex-wrap">
                    <div class="user-avatar mb-2 mb-xl-0">
                      <img src="{{ url('assets/images/faces/face6.jpg') }}" alt="profile image" class="profile-img img-lg rounded-circle">
                      <span class="edit-avatar-icon"><i class="mdi mdi-camera"></i></span>
                    </div>
                    <div class="wrapper pl-xl-4">
                      <div class="wrapper d-flex align-items-center">
              ...
              <div class="wrapper border-top">
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col d-flex align-items-center">
                      <div class="image-grouped ml-auto">
                        <img src="{{ url('assets/images/faces/face13.jpg') }}" data-toggle="tooltip" data-placement="top" title="Mary Sharp" alt="profile image">
                        <img src="{{ url('assets/images/faces/face14.jpg') }}" data-toggle="tooltip" data-placement="top" title="Cory Medina" alt="profile image">
                        <img src="{{ url('assets/images/faces/face4.jpg') }}" data-toggle="tooltip" data-placement="top" title="Clyde Hammond" alt="profile image">
