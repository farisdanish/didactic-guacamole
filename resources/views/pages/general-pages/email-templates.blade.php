                    ...
                    <tbody>
                      ...
                      <tr>
                        <td style="padding-top: 20px;">
                          <img style="float:left;" src="{{ url('assets/images/logo_blue.svg') }}" alt="Logo">
                      ...
                      #bbb;float:right;margin-top: 10px;">The best selling premium email template</p>
                        </td>
                      </tr>
                      <tr>
                    ...
                    <tr>
                      <td>
                        <table style="float:left;margin-right:15px;" cellpadding="0" cellspacing="0" border="0">
                          <tr>
                            <td style="background: #e6e6e6;color:#2b80ff;border-radius: 100%;height: 35px;width: 35px; margin-right:20px;">
                              <img style="display: block;margin: auto;max-width: 8px;" src="{{ url('assets/images/email/fb.png') }}" alt="facebook">
                            </td>
                          </tr>
                        </table>
                        <table style="float:left;margin-right:15px;" cellpadding="0" cellspacing="0" border="0">
                          <tr>
                            <td style="background: #e6e6e6;color:#2b80ff;border-radius: 100%;height: 35px;width: 35px; margin-right:20px;">
                              <img style="display: block;margin: auto;max-width: 15px;" src="{{ url('assets/images/email/twitter.png') }}" alt="facebook">
                            </td>
                          </tr>
                        </table>
                        <table style="float:left;margin-right:15px;" cellpadding="0" cellspacing="0" border="0">
                          <tr>
                            <td style="background: #e6e6e6;color:#2b80ff;border-radius: 100%;height: 35px;width: 35px; margin-right:20px;">
                              <img style="display: block;margin: auto;max-width: 15px;" src="{{ url('assets/images/email/youtube.png') }}" alt="facebook">
                            </td>
                          </tr>
                        </table>
                        <table style="float:left;margin-right:15px;" cellpadding="0" cellspacing="0" border="0">
                          <tr>
                            <td style="background: #e6e6e6;color:#2b80ff;border-radius: 100%;height: 35px;width: 35px; margin-right:20px;">
                              <img style="display: block;margin: auto;max-width: 15px;" src="{{ url('assets/images/email/medium.png') }}" alt="facebook">
                            </td>
                          </tr>
                        </table>
                        <table style="float:left;" cellpadding="0" cellspacing="0" border="0">
                          <tr>
                            <td style="background: #e6e6e6;color:#2b80ff;border-radius: 100%;height: 35px;width: 35px; margin-right:20px;">
                              <img style="display: block;margin: auto;max-width: 15px;" src="{{ url('assets/images/email/slack.png') }}" alt="facebook">
                            </td>
                          </tr>
                        </table>
                      </td>
                  ...
                  <table style="width: 550px;height: 100%;margin: 0 auto" cellpadding="0" cellspacing="0" border="0">
                    <tbody>
                      ...
                      normal;font-stretch: normal;line-height: 1.71;letter-spacing: normal;color: #001737;margin-bottom: 10px;"> Hi Cole Mendoza,</p>
                          ...
                          <a heref="#" style=" height: 34px;background-color: #2b80ff;border: none;color: #fff;padding: 8px 20px;border-radius: 4px;display: inline-block;margin-left: 10px;margin-bottom: 20px;">RESET PASSWORD</a>
                ...
                <td style="padding: 50px;">
                  <table style="width: 550px;height: 100%;margin: 0 auto" cellpadding="0" cellspacing="0" border="0">
                    <tbody>
                      ...
                      <tr>
                        <td style="padding-top: 20px;">
                          <img style="max-width: 100%;width:100%;border-radius: 10px;" src="{{ url('assets/images/email/mail-image.jpg') }}" alt="email image">
                        </td>
                      </tr>
                      <tr>
                      ...
                      normal;font-stretch: normal;line-height: 1.71;letter-spacing: normal;color: #001737;margin-bottom: 10px;"> Hi Cole Mendoza,</p>
                          ...
                          <a heref="#" style=" height: 34px;background-color: #2b80ff;border: none;color: #fff;padding:
