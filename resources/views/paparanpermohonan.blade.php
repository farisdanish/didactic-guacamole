...
<div class="container-fluid borang_ejkdb">
    <form id="borang_ejkdb" action="/hantar" method="post">
        ...
        <div class="container">
            ...
            {{-- <div class="applicationFormHeading text-center"><h4>SAYA <font color="green">MENYOKONG</font> CALON INI.</h4></div> --}}
            <div class="applicationFormHeading text-center"><h4>SAYA <font color="red">TIDAK MENYOKONG</font> CALON INI.</h4></div>
            <div class="container justify-content-center mb-3 mt-3 grid_table">
