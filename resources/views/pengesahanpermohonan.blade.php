...
<div class="container applicationFormHeading">
    <h1>Pengesahan Borang Permohonan</h1>
</div>
    ...
    <form id="borang_ejkdb" action="/hantar" method="post">
        ...
        <div class="container">
            ...
            {{-- <div class="container row justify-content-center">
                <div class="form-group row mt-3 mb-3 grid_table">
                    <div><label for="namajkdb" class="col-sm-5 col-form-label">Nama JKDB</label></div>
                    <div class="col-sm-6">
            ...
            <div class="container row justify-content-center">
                <div class="form-group row mb-3 grid_table">
                    <label for="negeri" class="col-sm-3 col-form-label">Negeri:</label>
                    <div class="col-sm-8">
