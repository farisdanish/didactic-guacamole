...
<div class="container applicationFormHeading">
    <h1>Paparan Semak Borang Permohonan</h1>
</div>
<div class="container-fluid borang_ejkdb">
    <form id="borang_ejkdb" action="/hantar" method="post">
        ...
        <div class="container">
            ...
            <div class="applicationFormHeading text-center"><h6>Pemohon telah disahkan oleh:</h6></div>
            <div class="container justify-content-center mb-3 mt-3 grid_table">
        ...
        <div class="container">
            <div class="borang_ejkdb_heading"><h5><b>BAHAGIAN H : UNTUK KEGUNAAN PEJABAT</b></h5></div>
            <div class="container justify-content-center mb-3 mt-3 grid_table">
                <div><b>Tarikh Terima</b>&nbsp;</div><div class="mb-3">&ensp;02/04/2024</div>
                <div><b>Nama Penerima</b>&nbsp;</div><div class="mb-3">&ensp;Abu bin Bakaar</div>
                <div><b>Agensi</b>&nbsp;</div><div class="mb-3">&ensp;KKTP</div>
                <div><b><font color="red">Status</font></b>&nbsp;</div>
                <div class="mb-3"><font color="red"><b>&ensp;Dikembalikan</b></font></div>
            </div>
        </div>
    </form>
</div>
